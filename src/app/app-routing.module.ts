...
import { GuardLoginUserGuard } from './views/guards/guard-login-user.guard';
...
const routes: Routes = [
  {path:'',component:HomeLayoutComponent,children:[
    ...
    {path:'login',canActivate:[GuardLoginUserGuard],loadChildren:()=>import('./views/home/sign-in-user/sign-in-user.module').then(m=>m.SignInUserModule)}
  ]},
